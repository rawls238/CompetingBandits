...
We present the experiments omitted from Section \ref{sec:non_greedy}. These represent the results of the HardMaxWithRandom choice model on the Uniform and Needle-In-Haystack instances. 
...
\hline
\end{tabular}
\caption{Uniform (HardMaxWithRandom)}
\vspace{-6mm}
\end{table}
...
\end{tabular}
\caption{Needle In Haystack (HardMaxWithRandom)} 
\vspace{-6mm}
\end{table}
