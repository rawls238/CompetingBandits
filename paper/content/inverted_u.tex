...
\xhdr{Welfare.}
We also study the effects of the competition on the consumer welfare---the total reward received by the users over time.
...
\asedit{Rather than the welfare directly, we find it more illuminating to consider} \emph{market regret}: the difference between the cumulative mean rewards achieved by taking the best action over all rounds and the cumulative mean rewards received by the agents. (Hence smaller regret means higher welfare.)
...
\swedit{We also observe that monopoly and duopoly achieve similar
  welfare, with monopoly being marginally better than duopoly. This is
