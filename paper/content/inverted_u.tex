...
\begin{figure}
\includegraphics[scale=0.25]{figures/unif_eq_welfare}
\includegraphics[scale=0.25]{figures/ht_eq_welfare}
...
\begin{figure}
\includegraphics[scale=0.25]{figures/eeog_vs_num_ht}
\includegraphics[scale=0.25]{figures/ht_many_firm_welfare}\\
...
\asedit{We track the average \Eeog in each of the
