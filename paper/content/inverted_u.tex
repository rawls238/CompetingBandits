...
\swcomment{Guy: could you add lines and make the table 3 $\times$ 3 grid? Now it's hard to read which number belongs to which cell...}
...
start, $\DG$ was the optimal strategy.\footnote{However, we report the
  ...
  strategy for both the entrant and incumbent.}\swcomment{I don't
  understand this sentence. what's the point?} \swdelete{It seems clear that the
  temporary monopoly will get a larger market share regardless of what
  algorithm it plays.}
