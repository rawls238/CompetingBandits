...
\ascomment{Describe the inverted-U in the findings above.}
...
\begin{finding}
\textit{
Under permanent duopoly, \Eeog values tend to be much smaller than the time horizon $T$, but tend to increase as the warm start $T_0$ increases.
}
\end{finding}

\ascomment{Can we cook up an explanation for why \Eeog grows with $T_0$?}
