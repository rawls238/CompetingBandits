...
\asedit{We assume that both firms play their respective equilibrium strategies for the corresponding competition level} \gaedit{for $T_0 = 20$. As discussed previously, these are: (1) \DG in the monopoly, (2) \DG for both firms in duopoly from Finding \ref{find:duopoly}, (3) \TS for the incumbent (Finding \ref{find:temp-monopoly}) and \DG for the entrant in temporary monopoly (Finding \ref{find:temp-monopoly-entrant}).}
...
\TS. \gaedit{We also observe that monopoly and duopoly achieve similar welfare, with monopoly being marginally better than duopoly.}

\begin{finding}
\textit{ In equilibrium, consumer welfare is highest under temporary monopoly. Monopoly and duopoly achieve similar welfare with monopoly leading to marginally better welfare than duopoly.
}
\end{finding}



\gaedit{The result that monopoly leads to marginally better welfare than duopoly is surprising since, in equilibrium, all firms play \DG in both settings. One might conjecture that the welfare should increase with the number of firms playing \DG since more \DG runs
...
\begin{finding}
\textit{When all firms in the market deploy \DG, welfare is weakly decreasing as the number of firms in the market decreases.}
\end{finding}
