...
\swedit{a well-established concept in the economics literature, dating
  back to \cite{Schumpeter-42}.} \swedit{In this relationship, too
...
\swcomment{should we say ``reputation advantage'' alone does not give much advantage?}
\OMIT{ %%%%%%
