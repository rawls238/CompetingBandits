...
Our intuition for Finding~\ref{barrier-find}(b) is as follows. Suppose the incumbent switches from \DG to \TS. This switch allows the incumbent to explore actions more efficiently, and therefore should benefit the data advantage. However, the switch increases the reputation cost of exploration in the short run, which could weaken the reputation advantage. 
