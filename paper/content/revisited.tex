...
\item Given a sufficiently large $T_0$, if one algorithm's mean reputation trajectory lies above another (for instance, Figure  \ref{prelim_means}), then the first algorithm prevails in the competition game.
\end{conjecture}
