...
the \HM~ vs \HMR~ choice model. \swedit{In contrast to the \HM~ model,
  \TS becomes weakly dominant under the \HMR model, as $T$ gets
  sufficiently large.} These results hold across all problem
instances.\footnote{The results here are pulled using different \MRV
  ...
  section.\swcomment{not sure we need this}} The intuition for why \TS
