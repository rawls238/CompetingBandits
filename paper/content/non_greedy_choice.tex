...
instances. Table \ref{tab:additional_results} presents the results of the \HMR choice model for the Uniform and Needle-In-Haystack problem instances. \OMIT{\footnote{The results here are pulled using different \MRV
