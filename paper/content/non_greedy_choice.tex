...
\textit{\TS is weakly dominant under the \HMR~ choice rule, if and only if $\eps T$ is sufficiently large. \asedit{\HMR leads to lower variance in market shares, compared to \HM.}}
\end{finding}
