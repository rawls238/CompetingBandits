...
\begin{center}
\includegraphics[scale=0.25]{figures/uniform_mean}
\includegraphics[scale=0.25]{figures/ht_mean}
\includegraphics[scale=0.25]{figures/mean_inst_reward_ht}
\includegraphics[scale=0.25]{figures/mean_inst_reward_nih}
\includegraphics[scale=0.25]{figures/mean_inst_reward_uniform}
\end{center}
...
\section{Non-Greedy Choice Results}
