...
We present an additional experiment on the permanent duopoly from Section 4, namely, the experiment for the Uniform instance. The results displayed in the table are the same contain the same information as those in the text. The results can be seen in Table \ref{duopoly_unif}. They are in the same format as those in the main text.
