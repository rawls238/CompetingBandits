...
\subsubsection{Main result on \HardMax: Proof of Theorem~\ref{thm:DG-dominance}}
...
{Lemma~\ref{lm:DG-rew} does not rely on any particular shape of the response function because it only considers the performance of each algorithm without competition.}
...
%%%%%%%%%%%%
\subsubsection{\HardMax with biased tie-breaking}
\label{sec:proofs-HM-main}

\begin{proof}[Proof of Theorem~\ref{thm:HardMax-hardTies}]
...
\begin{proof}[Proof of Theorem~\ref{thm:HardMax-biased}]
...
%%%%%%%%%%%%
\subsubsection{The main result for \HardMaxRandom: 
...
%%%%%%%%%%%%
\subsubsection{For \HardMaxRandom, a little greedy goes a long way
...
%%%%%%%%%%%%
\subsubsection{\SoftMaxRandom: proof of Theorem~\ref{thm:SoftMax-strong}}
