...
\asedit{While this material builds on a vast and active research area, we present sufficient background in Section~\ref{sec:related-classes}, so as to keep this paper accessible to non-specialists.}
...
Our model speaks to the ongoing debate on the role that data plays in the digital economy, \gaedit{which has been at the forefront of policy discussions on how to regulate major, data-intensive, digital platforms \citep{competition2019digital, scott2019committee}.} One fundamental question in this debate is whether data can serve a similar role as traditional ``network effects", \asedit{creating scenarios when only one firm can function in the market \citep{Rysman09, jullien2019economics}.}
...
\ascomment{Guy: citing \citet{varian2018artificial} might serve us, even if it is a more informal discussion. The existence of the policy discussion is worth mentioning, too (with citations).}
