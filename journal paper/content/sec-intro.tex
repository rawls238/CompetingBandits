...
\footnote{The greedy algorithm wins often but not always, whereas it
always wins under \TheoryModel. The reason for this discrepancy is that the greedy algorithm in the theoretical results is aware of the Bayesian prior.
}
