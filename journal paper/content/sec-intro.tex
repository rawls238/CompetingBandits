...
\asedit{While this material builds on a vast and active research area, we present sufficient background in Appendix~\ref{sec:related-classes}, so as to keep this paper accessible to non-specialists.}
...
\asedit{Our model speaks to policy discussions on regulating data-intensive digital platforms \citep{furman2019unlocking, scott2019committee}, and particularly to the ongoing debate on the role of data in the digital economy.} One fundamental question in this debate is whether data can serve a similar role as traditional ``network effects", \asedit{creating scenarios when only one firm can function in the market \citep{Rysman09, jullien2019economics}.}
