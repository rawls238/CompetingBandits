...
While we build on a vast and active research area, we present sufficient background in Appendix~\ref{sec:related-classes} so as to keep this paper accessible to non-specialists.
