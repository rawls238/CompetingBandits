...
We focus on innovation in \emph{exploration technology} which systematically improves the firm's products, whereas prior work would define innovation as improvement in the products themselves. We recover the \asdelete{traditional} inverted-U relationship purely through the reputational consequences of exploration.
\asdelete{rather than monetary costs/benefits thereof.}
By contrast, the inverted-U relationships from prior work rely on the monetary aspects: \asedit{investments into  R\&D and profits from innovation.}
