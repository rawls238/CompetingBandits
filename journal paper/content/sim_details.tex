...
We use \Thompson (\TS) from the ``adaptive-exploration" algorithms, \DynamicEpsGreedy (\DEG) with exploration probability $\eps=5\%$ from the ``exploration-separating" algorithms,%
