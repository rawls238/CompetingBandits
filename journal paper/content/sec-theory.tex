...
The competition game has a unique Nash equilibrium: both principals choose \DynGreedy. \asedit{This holds even if the principals can only choose from restricted strategy sets which include \DynGreedy.}
\end{corollary}
