...
\asedit{These conclusions hold even if each principal's strategy set is a subset of \bmonotone MAB algorithms that is closed under the greedy modification.}%
