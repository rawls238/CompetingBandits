...
\citet{Bubeck-survey12,slivkins-MABbook,LS19bandit-book} for background on regret-minimizing formulations of bandits, \citet{Gittins-book11} for Bayesian and Markovian formulations, and \citet{CesaBL-book,slivkins-MABbook} for connections to economics and game theory.} A discussion of industrial applications of MAB can be found in \citep{DS-arxiv} and \citep[Ch. 8]{slivkins-MABbook}.
