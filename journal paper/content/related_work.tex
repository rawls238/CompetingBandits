...
The literature on learning-by-doing vs. competition \citep[\eg][]{gilbert1982preemptive, fudenberg1983learning, dasgupta1988learning, cabral1994learning} 
\asmargincomment{Guy: pls cite Gilbert-Newberry, as per YK.}
...
\gadelete{Second, there a large literature on non-existence of equilibria due to small deviations, starting with \cite{Rothschild-Stiglitz-76} in the context of health insurance markets.
\asdelete{\footnote{\cite{Veiga-Weyl-16,Azevedo-Gottlieb-17} emphasize the distinction between \HardMax and versions of \SoftMaxRandom in this context.}}
...
Third, choice models similar to \SoftMaxRandom are used to explain  horizontal product differentiation \citep[\eg][]{Hotelling-29, Perloff-Salop-85}.
