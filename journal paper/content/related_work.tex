...
\footnote{The planner faces a two-armed bandit problem, rather than a pricing problem. This is because the planner can directly choose a firm for each agent (by choosing a very low price for this firm, and a very high price for the other firm, because payments cancel out in social welfare).}
