...
\asmargincomment{It serves us to discuss this work here, IMO, and we have an excuse.}
...
\asedit{\cite{schmalensee1982product, bagwell1990informational} investigate how buyer uncertainty about product quality can serve as a barrier to entry for late arrivers; we find a similar effect with ``reputation advantage". The role of data as a barrier to entry in online markets has been noted in \cite{de2020data}; we find a similar effect with ``data advantage". \citet{kerin1992first} overview the other channels through which first-mover advantage can lead to a competitive advantage.}
