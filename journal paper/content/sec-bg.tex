...
\footnote{While Thompson Sampling dates back to 1933 and is probably the best-known bandit algorithm, its regret has not been understood until recently \citep{Shipra-colt12}.}
...
\citep{practicalCB-arxiv18}, and in theory \citep{kannan2018smoothed,externalities-colt18} under (very) substantial assumptions. The prevalent intuition is that the diversity of contexts can --- under some conditions and to a limited extent --- substitute for explicit exploration.
