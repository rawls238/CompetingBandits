...
We focus on the three classes of MAB algorithms listed in Section~\ref{expts-prelims}: adaptive-exploration algorithms, exploration-separating algorithms, and greedy algorithms. We list the precise upper and lower bounds on the regret rates only to illustrate how the three algorithm classes are separated from one another; the exact results are not essential for the paper.
