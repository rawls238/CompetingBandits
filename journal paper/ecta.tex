...
This is a merged version, with a unified and streamlined presentation and expanded related work and background materials. All theoretical results are from \citet{CompetingBandits-itcs18}, and all numerical simulations are from \citet{CompetingBandits-ec19}. Appendices~\ref{app:bg},\ref{app:examples} are new. \newline \indent
