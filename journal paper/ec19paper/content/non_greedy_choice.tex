...
\textit{\Thompson is weakly dominant under \HardMaxRandom, if and only if $\eps T$ is sufficiently large. Moreover, \HardMaxRandom leads to lower variance in market share, compared to \HardMax.}
\end{finding}
