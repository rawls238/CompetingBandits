...
& \makecell{  \textbf{0.44} $\pm$ 0.02 \\Var: 0.064 }
 %%
  ...
  \\
   \hline
\end{tabular}
\caption{\HardMaxRandom (\HMR) choice model for Uniform and Needle-In-Haystack MAB instances.}
