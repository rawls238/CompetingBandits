...
% First, we provide mean reputation trajectories for the Heavy-Tail MAB instance. Second, we provide trajectories for the average of the instantaneous mean rewards, for all three MAB instances. the mean reward trajectories provides a better view into the direct performance of the algorithm at a given time $t$ as, unlike reputation, it does not aggregate performance across many previous time periods.
