...
\textit{\\
(a) Data advantage and reputation advantage alone are large, across all algorithms and MAB instances. \\(b) The data advantage is larger than the reputation advantage when the incumbent chooses \TS. \\(c) The two advantages are similar in magnitude when the incumbent chooses \DEG or \DG.
}
\end{finding}
