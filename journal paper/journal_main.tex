...
% model variants
\newcommand{\TheoryModel}{the Bayesian-choice model}
\newcommand{\emTheoryModel}{the \emph{Bayesian-choice model}}
\newcommand{\ExptsModel}{the reputation-choice model}
\newcommand{\emExptsModel}{the \emph{reputation-choice model}}
