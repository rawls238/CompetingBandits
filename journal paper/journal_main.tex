...
with a unified and streamlined presentation and expanded background materials. All theoretical results are from \citet{CompetingBandits-itcs18}, and all experiments are from \citet{CompetingBandits-ec19}. Appendices~\ref{app:bg},\ref{app:examples} are completely new compared to the conference versions. We would like to thank Yeon-Koo Che, Glen Weyl, Sven Rady, and seminar participants at Columbia, ACM Economics and Computation, and Innovations in Theoretical Computer Science for helpful comments and conversations. All errors are our own.} }
