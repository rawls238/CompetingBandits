...
% model variants
\newcommand{\TheoryModel}{the Bayesian-choice model\xspace}
\newcommand{\emTheoryModel}{the \emph{Bayesian-choice model}\xspace}
\newcommand{\ExptsModel}{the reputation-choice model\xspace}
\newcommand{\emExptsModel}{the \emph{reputation-choice model}\xspace}
