...
for (prior in priors) {
  for (j in 1:length(time_horizons)) {
    ...
    colnames(results) <- c(paste(concise_alg_rep(alg_pairs[1]), concise_alg_rep(alg_pairs[2]), sep=" vs "), paste(concise_alg_rep(alg_pairs[3]), concise_alg_rep(alg_pairs[4]), sep=" vs "), paste(concise_alg_rep(alg_pairs[5]), concise_alg_rep(alg_pairs[6]), sep=" vs "))
