...
dat <- read.csv(file=paste(WORKING_PATH, "/results/free_obs_raw_results/free_obs_experiment_greedy_thompson_2_raw.csv", sep=""))
...
time_horizons <- c(3000)
priors <- as.list(unique(dat['Prior']))$Prior

ZERO_ONE_CUTOFF <- 0.1
algs <- c("ThompsonSampling", "ThompsonStaticGreedy", "ThompsonDynamicGreedy")
alg_names <- c("Thompson Sampling", "Thompson Static Greedy", "Thompson Dynamci Greedy")
