...
time_horizons <- c(5000, 10000, 15000)
      ...
      print_breaks <- FALSE
        ...
        for (k in 1:length(algs)) {
          for (l in 1:length(algs)) {
            ...
            results[k, l] <- paste("<b>", signif(mean(share), digits=2), "</b> +/-", cin, "<br>", signif(var(share), digits=2), paste("(", lower_var, ", ", high_var, ")", sep=""), "<br>", "Extreme Shares:", shares)
          }
        }
