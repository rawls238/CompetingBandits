...
f <- "tournament_experiment_ws_small_erase_rep_raw.csv"
...
for (prior in priors) {
  ...
  colnames(results) <- lapply(warm_starts, function (start) { return(paste("WS =", start))})
  ...
  tab <-xtable(results, caption=paste("Results for", prior, "HardMax", "K=10, erased reputation"))
  print(tab, type="html")
  if (prior != ".5/.7 Random Draw") {   print("<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>") }
