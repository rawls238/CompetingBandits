...
simultaneous_welfare <- read.csv("/Users/garidor/Desktop/CompetingBandits/results/tournament_raw_results/tournament_experiment_full_welfare_calc_raw.csv")
free_obs_welfare <- read.csv("/Users/garidor/Desktop/CompetingBandits/results/free_obs_raw_results/free_obs_experiment_welfare_calc_raw.csv")
#prelim <- read.csv("/Volumes/Mac/final_bandit_results/results/preliminary_raw_results/longer_ws.csv")
prelim <- read.csv("/Users/garidor/Desktop/CompetingBandits/results/preliminary_raw_results/regret_calc.csv")
...
many_markets <- read.csv("/Users/garidor/Desktop/CompetingBandits/results/tournament_raw_results/tournament_experiment_many_markets_raw.csv")
...
ggplot(select_firms, aes(x=Time.Horizon, y=Market.Regret)) + geom_smooth(aes(colour=NumFirms)) +
  xlab("Time") + ylab("Market Regret") + ggtitle("Welfare - Greedy, Heavy Tail") + theme_bw(base_size = 12) + theme(plot.title = element_text(hjust = 0.5))
